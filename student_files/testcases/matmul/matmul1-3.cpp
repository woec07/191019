  ...
  
{
  ...
  // Optimization 2: maximizin LMULs (usage of 22 physical regs) -> DONE TC_4 = [84.75, 94.54]% improvement, LUT_4 = 17262
  // Optimization 3: changing pipeline strucutre and widening
  // -> TC_4 = [85.36, 94.53]% improvement, LUT_4 = | TC_8: [42.03, 78.342]%, LUT_8 = 
