...
bool run_test(int test_num)
{
    ...
    int16_t *output = (int16_t*)vicuna_malloc(2 * vecLen);

    int8_t* vec_a = (int8_t*)vec_a_array[test_num];
    int8_t* vec_b = (int8_t*)vec_b_array[test_num];
    ...
    //Verfiy results
    int16_t* vec_c = (int16_t*)vec_c_array[test_num];
...
bool validate_output(int16_t* output, int16_t* reference, uint32_t vecLen)
{
...
{
    printf("Testcase:\n\n");
    printf("Vector Addition - Vectors %d elements long:\n\n", vecLen);
